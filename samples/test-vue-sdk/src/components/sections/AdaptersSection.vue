  ...
  <div class="space-y-6">
    ...
    <Card>
      <div class="space-y-4">
        ...
        <div class="space-y-4">
          <div>
            <Typography variant="h4" class="mb-3">Google Authentication</Typography>
            <div class="space-y-3">
              <div>
                <Typography variant="h5" class="mb-2">Standard Google Button</Typography>
                <GoogleButton />
              </div>
              
              <div>
                <Typography variant="h5" class="mb-2">Custom Google Button</Typography>
                <GoogleButton>
          ...
          <div>
            <Typography variant="h4" class="mb-3">GitHub Authentication</Typography>
            <div class="space-y-3">
              <div>
                <Typography variant="h5" class="mb-2">Standard GitHub Button</Typography>
                <GitHubButton />
              </div>
              
              <div>
                <Typography variant="h5" class="mb-2">Custom GitHub Button</Typography>
          ...
          <div>
            <Typography variant="h4" class="mb-3">Microsoft Authentication</Typography>
            <div class="space-y-3">
              <div>
                <Typography variant="h5" class="mb-2">Standard Microsoft Button</Typography>
                <MicrosoftButton />
              </div>
              
              <div>
                <Typography variant="h5" class="mb-2">Custom Microsoft Button</Typography>
          ...
          <div>
            <Typography variant="h4" class="mb-3">Facebook Authentication</Typography>
            <div class="space-y-3">
              <div>
                <Typography variant="h5" class="mb-2">Standard Facebook Button</Typography>
                <FacebookButton />
              </div>
              
              <div>
                <Typography variant="h5" class="mb-2">Custom Facebook Button</Typography>
