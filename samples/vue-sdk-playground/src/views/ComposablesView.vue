                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                  <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <pre class="bg-white border border-gray-200 p-2 rounded text-xs overflow-auto max-h-32">{{ JSON.stringify(user, null, 2) }}</pre>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <SignedIn>
              <div class="space-y-3">
                ...
                <div v-if="organizationResults.allOrganizations" class="bg-gray-50 p-4 rounded-lg">
                  ...
                  <pre class="bg-white border border-gray-200 p-2 rounded text-xs overflow-auto max-h-32">{{ JSON.stringify(organizationResults.allOrganizations, null, 2) }}</pre>
                </div>
                ...
                <div v-if="organization" class="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <pre class="bg-white border border-gray-200 p-2 rounded text-xs overflow-auto max-h-20">{{ JSON.stringify(organization, null, 2) }}</pre>
                  </div>
                </div>
              </div>
            </SignedIn>
