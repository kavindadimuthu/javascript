...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: 'code',
    children: [
      { path: '/composables/asgardeo', label: 'useAsgardeo' },
      { path: '/composables/user', label: 'useUser' },
      { path: '/composables/organization', label: 'useOrganization' },
      { path: '/composables/flow', label: 'useFlow' },
      { path: '/composables/flowMeta', label: 'useFlowMeta' },
      { path: '/composables/theme', label: 'useTheme' },
      { path: '/composables/branding', label: 'useBranding' },
      { path: '/composables/i18n', label: 'useI18n' },
    ],
  },
];
