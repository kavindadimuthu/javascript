 ...
 */
const BaseSignUp: ReturnType<typeof defineComponent> = defineComponent({
  name: 'BaseSignUp',
  props: {
      ...
      return h(
        ...
        [
          ...
          h(
            ...
            'Coming Soon — This embedded sign-up component will be available when app-native authentication flow is implemented.',
          ),
        ],
      );
    };
