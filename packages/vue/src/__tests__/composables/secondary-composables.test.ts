...
describe('useFlow', () => {
  ...
  it('should throw an error when called outside of AsgardeoProvider', () => {
    ...
    expect(() => {
      mount(TestChild);
    }).toThrow('[Asgardeo] useFlow() was called outside of <AsgardeoProvider>');
  });
});
...
describe('useFlowMeta', () => {
  ...
  it('should throw an error when called outside of AsgardeoProvider', () => {
    ...
    expect(() => {
      mount(TestChild);
    }).toThrow('[Asgardeo] useFlowMeta() was called outside of <AsgardeoProvider>');
  });
});
...
describe('useTheme', () => {
  ...
  it('should throw an error when called outside of AsgardeoProvider', () => {
    ...
    expect(() => {
      mount(TestChild);
    }).toThrow('[Asgardeo] useTheme() was called outside of <AsgardeoProvider>');
  });
});
...
describe('useBranding', () => {
  ...
  it('should throw an error when called outside of AsgardeoProvider', () => {
    ...
    expect(() => {
      mount(TestChild);
    }).toThrow('[Asgardeo] useBranding() was called outside of <AsgardeoProvider>');
  });
});
...
describe('useI18n', () => {
  ...
  it('should throw an error when called outside of AsgardeoProvider', () => {
    ...
    expect(() => {
      mount(TestChild);
    }).toThrow('[Asgardeo] useI18n() was called outside of <AsgardeoProvider>');
  });
});
