...
describe('SignedIn', () => {
  it('should render default slot content when user is signed in', () => {
    const mockContext = createMockAsgardeoContext({isSignedIn: ref(true)});
  ...
  it('should not render default slot content when user is not signed in', () => {
    const mockContext = createMockAsgardeoContext({isSignedIn: ref(false)});
...
describe('Loading', () => {
  it('should render default slot content when loading', () => {
    const mockContext = createMockAsgardeoContext({isLoading: ref(true)});
  ...
  it('should not render default slot content when not loading', () => {
    const mockContext = createMockAsgardeoContext({isLoading: ref(false)});
  ...
  it('should react to loading state changes', async () => {
    ...
    const mockContext = createMockAsgardeoContext({isLoading});
