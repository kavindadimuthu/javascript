...
describe('SignInButton', () => {
  it('should call signIn when clicked', async () => {
    ...
    const mockContext = createMockAsgardeoContext({signIn});
  ...
  it('should emit error event when signIn fails', async () => {
    ...
    const wrapper = mount(SignInButton, {
      global: {
        ...
        config: {
          errorHandler: () => {
            // Suppress unhandled AsgardeoRuntimeError thrown after emit
          },
        },
      },
    });
...
describe('SignOutButton', () => {
  it('should call signOut when clicked', async () => {
    ...
    const mockContext = createMockAsgardeoContext({signOut});
